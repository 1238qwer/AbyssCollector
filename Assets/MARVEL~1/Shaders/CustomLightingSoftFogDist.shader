...
//----------------------------------------------
Shader "Kirnu/Marvelous/CustomLightingSoftFogDist" {
	...
	Properties {
		...
		_ZFogColorStart("ZFog Start Color", Color) = (1,1,1,1)
		_ZFogColorMid("ZFog Mid Color", Color) = (1,1,1,1)
		_ZFogColorEnd("ZFog End Color", Color) = (1,1,1,1)
		...
		_ZFogStart("ZFogStart",Float) = 1
		_ZFogMidEnd("ZFogMid",Float) = 1
		_ZFogEnd("ZFogEnd", Float) = 1
	...
	SubShader {
		...
		Tags { "LIGHTMODE"="ForwardBase" "QUEUE"="Geometry" "RenderType"="Opaque" }
			...
			CGPROGRAM
				...
				uniform half4 _ZFogColorStart;
				uniform half4 _ZFogColorMid;
				uniform half4 _ZFogColorEnd;
				...
				uniform half _ZFogStart;
				uniform half _ZFogMidEnd;
				uniform half _ZFogEnd;
				...
				fixed4 frag(CL_OUT_WPOS v) : COLOR {
					...
					fixed4 yLerp = lerp(half4(_FogColor, 1), c, v.color.w);

					fixed4 ct = lerp(_ZFogColorStart, _ZFogColorMid, v.pos.w / _ZFogMidEnd) * step(v.pos.w , _ZFogMidEnd);

					ct += lerp(_ZFogColorMid, _ZFogColorEnd, (v.pos.w - _ZFogMidEnd) / v.pos.w - _ZFogMidEnd) * step(_ZFogMidEnd, v.pos.w);
					
					//ct += lerp(_ZFogColorMid, _ZFogColorEnd, (v.pos.w - _ZFogMidEnd)/ _ZFogMidEnd) * step(_ZFogMidEnd, v.pos.w);
				/*	if (v.pos.w - _ZFogMidEnd > 0)
					{
						ct += lerp(ct, c, (v.pos.w - _ZFogMidEnd) / _ZFogMidEnd) * step(_ZFogMidEnd, v.pos.w);
					}	*/
					return ct;
				#endif
				}
